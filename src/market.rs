use crate::{Animation, tile, crop, population, save_load, item, CAM_W, CAM_H};
use crate::Area;
use crate::Menu;
use crate::BG_H;
use crate::BG_W;
...
pub fn update_market_pos(p: &mut Player, m_item_vec: &Vec<item::Item>, player_vel: (i32, i32), in_menu: &mut Option<Menu>) {
...
pub fn draw_market(mut wincan: WindowCanvas,
                   m_pop: &population::Population,
                   cur_bg: &Rect,
                   m_item_vec: &Vec<item::Item>) -> WindowCanvas {
